...
Modifying existing variables or creating new variables
...
litter_mutated = mutate(litters_data_selected, wt_gain = gd18_weight - gd0_weight)
litters_without_missing = drop_na(litter_mutated, gd0_weight)
```
